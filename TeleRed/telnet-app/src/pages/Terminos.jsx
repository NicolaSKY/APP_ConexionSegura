...
const secciones = [
  {
    ...
    contenido: `Al acceder y utilizar los servicios de TeleRed — Conexión Segura ("TeleRed", "nosotros", "nuestro"), usted acepta estar vinculado por estos Términos y Condiciones de Servicio. Si no está de acuerdo con alguna parte de estos términos, no podrá acceder al servicio.
...
Estos términos se aplican a todos los visitantes, usuarios y otras personas que accedan o utilicen el servicio. El uso continuado de nuestros servicios después de cualquier modificación constituye su aceptación de los nuevos términos.`,
  },
  {
    ...
    contenido: `TeleRed ofrece servicios de telecomunicaciones que incluyen:
...
La disponibilidad del servicio puede variar según la zona geográfica del usuario. TeleRed se reserva el derecho de modificar, suspender o discontinuar cualquier parte del servicio en cualquier momento.`,
  },
  {
...
- Notificar inmediatamente a TeleRed sobre cualquier uso no autorizado
- Asegurarse de que su información de contacto esté actualizada

TeleRed no será responsable por pérdidas derivadas del uso no autorizado de su cuenta cuando usted no haya cumplido con estas obligaciones.`,
  },
  {
    titulo: '4. Facturación y Pagos',
    contenido: `Los servicios de TeleRed se facturan mensualmente. Al contratar nuestros servicios usted acepta:
...
El incumplimiento de estas normas puede resultar en la suspensión inmediata del servicio sin derecho a reembolso.`,
  },
  {
    ...
    contenido: `TeleRed recopila y procesa datos personales de conformidad con la Ley N° 29733 — Ley de Protección de Datos Personales del Perú. Los datos recopilados incluyen:
...
No vendemos ni compartimos su información personal con terceros sin su consentimiento, salvo requerimiento legal. Puede solicitar la eliminación de sus datos contactando a privacidad@TeleRed.pe`,
  },
  {
    titulo: '7. Garantía y Nivel de Servicio (SLA)',
    contenido: `TeleRed garantiza una disponibilidad del servicio del 99.5% mensual. En caso de interrupciones:
...
La garantía no aplica en casos de fuerza mayor, desastres naturales o fallas en infraestructura fuera del control de TeleRed.`,
  },
  {
...
- Inmediatamente en caso de incumplimiento grave por parte de TeleRed
...
La resolución no exime al cliente del pago de facturas pendientes.`,
  },
  {
    ...
    contenido: `TeleRed no será responsable por daños indirectos, incidentales, especiales, consecuentes o punitivos, incluyendo pérdida de ganancias, datos, uso, fondo de comercio u otras pérdidas intangibles resultantes de:
...
La responsabilidad máxima de TeleRed no excederá el monto pagado en los últimos 3 meses de servicio.`,
  },
  {
    titulo: '10. Modificaciones y Ley Aplicable',
    contenido: `TeleRed se reserva el derecho de modificar estos términos en cualquier momento. Las modificaciones entrarán en vigor 30 días después de su publicación en nuestra plataforma.
...
Para consultas sobre estos términos contacte a: legal@TeleRed.pe
      ...
      <div style={{ background: c.header, padding: '20px', color: 'white', boxShadow: '0 4px 20px rgba(0,0,0,0.3)' }}>
        ...
        <div style={{ background: 'rgba(255,255,255,0.15)', borderRadius: '12px', padding: '12px', backdropFilter: 'blur(10px)' }}>
          <p style={{ fontSize: '12px', opacity: 0.9, lineHeight: '1.5' }}>
            📋 Este documento establece los términos legales que rigen el uso de los servicios TeleRed. Lee detenidamente antes de aceptar.
          </p>
        </div>
      </div>
        ...
        <div style={{ background: c.card, borderRadius: '18px', padding: '20px', marginTop: '15px', boxShadow: '0 4px 16px rgba(0,0,0,0.08)', border: `1px solid ${c.border}` }}>
          <div onClick={() => setAceptado(!aceptado)}
            ...
            <p style={{ fontSize: '13px', color: c.text, lineHeight: '1.5' }}>
              He leído y acepto los <strong style={{ color: c.accent }}>Términos y Condiciones</strong> y la <strong style={{ color: c.accent }}>Política de Privacidad</strong> de TeleRed.
            </p>
          </div>
