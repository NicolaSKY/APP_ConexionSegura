...
const canales = [
  { icon: '📞', label: 'Línea gratuita', valor: '0800-TELERED (0800-835638)', color: '#1565c0', bg: '#e3f2fd' },
  { icon: '📱', label: 'WhatsApp', valor: '+51 999 123 456', color: '#2e7d32', bg: '#e8f5e9' },
  { icon: '✉️', label: 'Email', valor: 'soporte@TeleRed.pe', color: '#6a1b9a', bg: '#f3e5f5' },
  { icon: '🐦', label: 'Twitter / X', valor: '@TeleRedPeru', color: '#0288d1', bg: '#e3f2fd' },
  { icon: '📘', label: 'Facebook', valor: 'TeleRed Conexión Segura', color: '#1565c0', bg: '#e3f2fd' },
]
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '15px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <div>
              ...
              <p style={{ fontSize: '11px', opacity: 0.7 }}>TeleRed — Conexión Segura</p>
            </div>
          </div>
        </div>
